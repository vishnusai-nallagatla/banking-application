        ...
        if (connection != null) {
            try {
                ...
                if (rowsAffected > 0) {
                    ...
                    out.println("<script>alert('Account deleted successfully.'); window.location.href='Homepage.html';</script>");
                    ...
                    out.println("<script>alert('Unable to delete account. Please check your details or ensure balance is 0.'); window.location.href='Homepage.html';</script>");
                }
